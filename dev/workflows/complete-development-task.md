...
A requested repository change is ready to implement.
...
6. Update affected goals, architecture, decisions, governance, workflows,
   schemas, or feature documentation.
7. Review the final status and diff.
8. Create a checkpoint only if useful unfinished state remains.
