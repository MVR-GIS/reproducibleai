...
Status: historical design-stage exploration. References to instruction modules
and transcript-based workflows predate ADR-0006 and are not current package
architecture. Current agentic-context architecture is defined in `design.md`.
